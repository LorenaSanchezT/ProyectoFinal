admin = true;
tipoContaminacion = "rural";

var texto1 = "<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur elementum tincidunt arcu, ut pretium ex semper non. "+ 
...
var texto2 = "<p>Sed vulputate in tortor id laoreet. Aliquam egestas hendrerit hendrerit. Phasellus interdum ac purus id placerat. "+
...
var texto3 = "<p>Sed vulputate in tortor id laoreet. Aliquam egestas hendrerit hendrerit. Phasellus interdum ac purus id placerat. "+
"Integer consectetur lectus sagittis sapien aliquet accumsan. Vestibulum sit amet augue ultricies, vehicula neque eu, aliquet mi. "+
"Vestibulum sollicitudin vitae enim non mattis. Quisque ultricies, est sit amet varius tempor, turpis mauris laoreet ante, sit amet ornare arcu nisl sit amet dolor. "+
"Nam vitae volutpat enim, quis iaculis ante.</p>"+
"\n" + "\n"+
...
function instInformacion() {
    document.getElementById("informacion").innerHTML = texto1;
    document.getElementById("informacion2").innerHTML = texto2;
    document.getElementById("informacion3").innerHTML = texto3;
}
