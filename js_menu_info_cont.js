...
inicioSesion = sessionStorage.getItem("inicioSesion");
...
var texto1_RUR = "<p>Se suelen producir principalmente debido a las actividades humanas que se desarrollan en el campo, aunque también las hay naturales, y tienen su impacto en la naturaleza, pudiendo ocasionar daños a los ecosistemas y la biodiversidad. Los principales problemas ambientales en el campo son:</p>" +
    "\n" + "\n" +
    "<p>Contaminación agrícola:</p>" + "\n" + "<p>La actividad agrícola que con frecuencia se desarrolla en el campo genera diversos problemas ambientales. Uno de estos se deriva del uso de pesticidas, plaguicidas, herbicidas y fertilizantes químicos durante estas actividades. Estos productos generan contaminación atmosférica, para los suelos y para las aguas. La contaminación a su vez ocasiona perjuicios al ecosistema y a su biodiversidad</p>"
"\n" + "\n" +
    "<p>Donec sed nibh commodo, bibendum erat in, sodales eros. Suspendisse aliquam dolor urna, sit amet interdum lacus dignissim vitae. " +
    "Aenean nec magna at orci varius auctor eu eu velit. Curabitur tristique imperdiet arcu, sed rutrum mauris porta nec. " +
    "Donec ornare ex ac metus hendrerit tincidunt ac sed purus. Vestibulum a est quis mi venenatis imperdiet sed a ex. " +
...
function instInformacion() {
    ...
    if (tipoContaminacion == "maritima") {
        ...
        document.getElementById("img1").setAttribute("src", "./images/contaminacion-maritima-recortada.png"),
            document.getElementById("img3").setAttribute("src", "./images/contaminacion-maritima2-recortada.png");
    } else if (tipoContaminacion == "rural") {
        ...
        document.getElementById("img1").setAttribute("src", "./images/contaminacion-rural-recortada.png"),
            document.getElementById("img3").setAttribute("src", "./images/contaminacion-rural2-recortada.png");
    } else if (tipoContaminacion == "urbana") {
        ...
        document.getElementById("img1").setAttribute("src", "./images/contaminacion-urbana-recortada.png"),
            document.getElementById("img3").setAttribute("src", "./images/contaminacion-urbana2-recortada.png");
    };
...
function cambioColores() {
    if (tipoContaminacion == "maritima") {
        ...
        document.getElementById("mapa").setAttribute("src", "./mapas/mapa interactivo cont maritima/index.html");
    }
    else if (tipoContaminacion == "rural") {
        ...
        document.getElementById("mapa").setAttribute("src", "./mapas/mapa interactivo cont rural/index.html");
    }
    else if (tipoContaminacion == "urbana") {
        ...
        document.getElementById("mapa").setAttribute("src", "./mapas/mapa interactivo cont urbana/index.html");
    }


    if (inicioSesion == "true") {
        document.getElementById("cont_logo_usu").style.visibility = "visible";
        document.getElementById("eventos").style.display = "flex";
        document.getElementById("linkEventos").style.visibility = "visible";
    } else {
        document.getElementById("cont_logo_usu").style.visibility = "hidden";
        document.getElementById("eventos").style.display = "none";
        document.getElementById("linkEventos").style.visibility = "hidden";
        document.getElementById("confirmEventos").style.display = "none";
    }

    console.log(admin);
    if (admin == "true") {
        document.getElementById("confirmEventos").style.display = "flex";
    } else {
        document.getElementById("confirmEventos").style.display = "none";
    }
